...
fn main() {
    ...
    // let mut rsp = reqwest::blocking::get("https://github.com/verisense-network/verisense/raw/refs/heads/feature/a2a/metadata/metadata.scale").expect("downloading metadata failed");
